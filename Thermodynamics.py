...
class NozzleInput:
    ...
    fuel_tank_V: float = 0.001
    oxidizer_tank_p: float = 5.0e6
    oxidizer_tank_T: float = 293.15
    oxidizer_tank_V: float = 0.001
    fuel_injector_d: float = 0.0008
    fuel_injector_L: float = 0.002
    fuel_injector_count: float = 1.0
    fuel_injector_Cd: float = 0.75
    oxidizer_injector_d: float = 0.0008
    oxidizer_injector_L: float = 0.002
    oxidizer_injector_count: float = 1.0
    oxidizer_injector_Cd: float = 0.75
...
def _print_result(result):
    ...
    print(f"Gamma (k) : {state['gamma']:.4f}")
